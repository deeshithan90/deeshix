    ...
    <div className='our-b'>
      ...
      <div className='yu' style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:40}}>
          <div style={{color : 'black',}}>
              <div>
                <h1 className='text-2xl' style={{color:'#BF00FF'}}>Quality-Driven Development</h1>
                <br></br>
              ...
              <br></br>
              <div>
                <h1 className='text-2xl' style={{color:'#BF00FF'}}>Innovation & Modern Technology</h1>
                <br></br>
              ...
              <br></br>
              <div>
                  <h1 className='text-2xl' style={{color:'#BF00FF'}}>Performance & Reliability</h1>
                  <br></br>
              ...
              <br></br>
              <div>
                <h1 className='text-2xl' style={{color:'#BF00FF'}}>Continuous Support</h1>
                <br/>
          ...
          <div>
                <img className='imh' src={logo} style={{width:200,height:200}}/>
          </div>
      </div>
    </div>
  )
