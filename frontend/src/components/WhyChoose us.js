const WhyChooseus = () => {
  return (
    <>
      <br></br>
      <h2 id='id6' className='text-2xl csaa ml-10'>Why choose us?</h2>
      ...
      <div class="marqueezz">
        <div class="marqueez-content">
          ...
          <div class="logo">
            <h2 className='text-2xl' style={{ color: 'white' }}>fdsdsfsfds</h2>
          </div>
      ...
      <div className='' style={{ color: 'black' }}>
        <div className='f-1'>
          <div>
            <h2 className='text-bold text-2xl' style={{ color: '#CCFF00',padding:10,borderRadius:25, display:'inline-block' }}>Strategic Web Development Solutions</h2>
            <br></br>
            <br />
          ...
          <div>
            <h2 className='text-bold text-2xl' style={{ color: '#CCFF00',padding:10,borderRadius:25, display:'inline-block' }}>Scalable & Secure MERN Stack Solutions</h2>
            <br></br>
            <br />
      ...
      <div className='' style={{ color: 'black' }}>
        <div className='f-1'>
          <div>
            <h2 className='text-bold text-2xl' style={{ color: '#CCFF00' ,padding:10,borderRadius:25, display:'inline-block'}}>Fast Delivery with Quality Assurance</h2>
            <br></br>
            <br />
          ...
          <div>
            <h2 className='text-2xl' style={{ color: '#CCFF00',padding:10,borderRadius:25, display:'inline-block'}}>Reliable & On-Time Technical Support</h2>
            <br></br>
            <br />
