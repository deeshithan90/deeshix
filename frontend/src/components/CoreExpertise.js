...
const CoreExpertise = () => {
    return (
        <>
        <h1 className='text-3xl font-bold underline clor'>Core Expertise</h1>
        <div className='grids'>
            {/**MongoDB*/}
            <div className='flex gap-4'>
                <BiLogoMongodb size={20} />
                <p style={{color:'#CCFF00'}}>MongoDB</p>
            </div>
            {/**Express.js*/}
            <div className='flex gap-4'>
                ...
                <p style={{color:'#CCFF00'}}>Express.js</p>
            </div>
            {/**React.js*/}
            <div className='flex gap-4'>
                <FaReact size={20}/>
                <p style={{color:'#CCFF00'}}>React.js</p>
            </div>
            {/**Node.js*/}
            <div className='flex gap-4'>
                <FaNodeJs size={20}/>
                <p style={{color:'#CCFF00'}}>Node.js</p>
            </div>
            {/**REST API Development*/}
            <div className='flex gap-4'>
                <FaServer size={20} />
                <p style={{color:'#CCFF00'}}>REST API Development</p>
            </div>
            {/**JWT*/}
            <div className='flex gap-4'>
                <FaUser size={20}/>
                <p style={{color:'#CCFF00'}}>Authentication & Authorization (JWT)</p>
            </div>
            {/**Database Modeling with Mongoose ODM*/}
            <div className='flex gap-4'>
                <BiLogoMongodb size={20}/>
                <p style={{color:'#CCFF00'}}>Database Modeling with Mongoose ODM</p>
            </div>
        </div>
        </>
    )
