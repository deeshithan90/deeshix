      ...
      <div className='about'>
        ...
        <div>
          <p style={{ color: '#f7f7f7', padding: 10 }} ><div className="mb-0 mt-10 w-full">
            ...
            specialized in MongoDB, Express.js , React.js Node.js Mongoose ODM TanstackQuery , JWT , dotenv, cookieparser, Java script Type script , css , html, tailwindcss python,  Django.
