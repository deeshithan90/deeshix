...
const CreatorVoice = () => {
  return (
    <div className='p-3'>
         <h1 className='ml-10 text-3xl csaa'>Deeshix Technology</h1>  
         <br></br>
         <div className='about'>
            <div>
            ...
            <br/>
            <div>
                <p style={{color:'#f7f7f7', padding:10}} >Hi, I’m Deeshithan Sathish, a passionate young MERN stack developer focused on building modern, high-quality digital solutions. Aim to provide website to all Buisness module with low budjet. While many people my age consume technology, I choose to create it. I am a self-taught developer who transformed learning time into real-world building by studying and following industry-leading engineers. I specialize in HTML, CSS, JavaScript, Python, and Node.js, with hands-on experience in frameworks and technologies such as React, React Native, Express, MongoDB, Flutter, 
