...
<br/>
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-around'}}>
             <div style={{display:'flex',alignItems:'center', columnGap:20}}>
                <div style={{backgroundColor:'#0F2632', padding:20, width:900}}>
                    <h1 className='text-3xl' style={{color:'#41C1BA'}}>About us</h1>
                    <br></br>
                    <p className='text-white' style={{width:800}}>We are a software development team focused on delivering reliable, scalable, and cost-effective digital solutions. Our goal is to help businesses grow by building high-quality software that solves real problems while staying within budget and timelines
