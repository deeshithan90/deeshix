        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-around'}}>
             <div style={{display:'flex',alignItems:'center', columnGap:20}}>
                <div style={{backgroundColor:'#CCFF00', padding:20}}>
                    <h1 className='text-3xl' style={{color:'#050505'}}>About us</h1>
                    <br></br>
                    <p style={{color:'#050505'}}>We are a software development team focused on delivering reliable, scalable, and cost-effective digital solutions. Our goal is to help businesses grow by building high-quality software that solves real problems while staying within budget and timelines
