...
<br/> 
        ...
        <h3 className="lg:text-3xl lg:font-bold lg:mt-10 ml-10 lg:w-[400px] mt-20 kls">Deeshix Technology - Leading Web Development Company in Chennai</h3>
        ...
        <h3 className="lg:text-3xl lg:font-bold lg:mt-10 ml-10 lg:w-[500px] kls">Build Your Digital Presence with Experts</h3>
        <p className="mt-10 text-2xl text-left w-3/4 ml-10">
